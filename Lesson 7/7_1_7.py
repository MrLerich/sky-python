...
employees = {
    ...
    "Довлатова": {"f": "Довлатова", "i": "Эмилия", "o": "Ефимовна", "pass": "342 020", "birthday": "18 мая 2001 года","phone": "+7 (924) 588-50-15", "position": "технолог"},
...
for item in employees.items():
    print(item["f"], item["i"], item["o"], item["pass"], item["birthday"], item["phone"])
