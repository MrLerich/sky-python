...
numb = int(input('введите номер экскурсовода: '))
# num_input = int(input())
# print(guides[num_input - 1]["fields"]["full_name"] +  ', туров: ' + str(guides[num_input - 1]["fields"]["tours_count"]))
# print(guides[num_input - 1]["fields"]["bio"])
for i in guides:
    if i['pk'] == numb:
        name_guide = i['fields']['full_name']
        t_count = i['fields']['tours_count']
        biogr = i['fields']['bio']
        print(f'{name_guide}, туров: {t_count}\n{biogr}')

'''Георги Беридзе, туров: 5
Филолог-журналист по образованию. За плечами более 9 лет экскурсий по Грузии и барменский опыт. Писатель. Перфекционист. 
И просто увлеченный человек. Родился и вырос в Тбилиси. Более 10 поколений тут. Люблю этот райский уголок на планете и свою работу. Мама-кулинар привила любовь к вкусной еде.'''
