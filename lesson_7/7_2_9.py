...
'''Теперь мы предоставим вам структуру данных с высокой вложенностью. Это данные экскурсоводов. Выведите экскурсоводов, у которых количество туров больше или равно 5 в формате:
